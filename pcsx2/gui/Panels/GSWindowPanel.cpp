	...
	: BaseApplicableConfigPanel_SpecificConfig(parent)
{
	...
	s_AspectRatio += Label(_("Aspect Ratio:") + wxString(" ") + fmt::format("({})", wxGetApp().GlobalAccels->findKeycodeWithCommandId("GSwindow_CycleAspectRatio").toTitleizedString().ToStdString())) | pxMiddle;
